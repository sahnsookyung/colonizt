...
- PR gate: `npm run lint`, `npm run typecheck`, `npm run test:unit`, `npm run test:property`, `npm run test:integration`, `npm --workspace @colonizt/web run test`, and `npm run smoke:network`.
